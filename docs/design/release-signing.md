...
(decided 2026-09-15, `docs/decisions/2026-09-15-stable-component-ids.md`; not
implemented yet, `mica-core` first). `mica/deployment/v2` and `mica/catalog/v2` were decided on
