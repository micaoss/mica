...
contract for campaign `mica-open-plans-20260910-100408`, L2 B `8t4ghqi6`.
...
- Evidence: `/tmp/mica-b3-checks.hMNe51/`; tmux `8ezwxfy2-2f3c00`.
...
- complete: Completed approved B3 software implementation and focused verification for L2 review; B7 caller/guest and A physical evidence remain separate. Campaign mica-open-plans-20260910-100408.
...
- Static x64 software delivery: direct rustix/typed DM worker backend, strict
  ...
  `/tmp/mica-b3-static.3ttniist`; full results and limitations are in the plan.
...
- reopen (2026-09-11, explicit user/L1 direction relayed by B): Continued the
  ...
  transitions must use the original serializer. Campaign mica-open-plans-20260910-100408.
