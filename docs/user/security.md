...
> status: shipped — evidence: `mica-deploy:src/bin/mica-init.rs`, `docs/design/ro-root.md`, `docs/design/release-signing.md`
...
> status: shipped — evidence: `mica-deploy:src/acquisition.rs`, `mica-deploy:src/deployments.rs`, `docs/design/release-signing.md`
