...
- **Purpose**: answer "what is Mica OS" in one screen, honestly, for a visitor who
...
Mica OS is an embedded appliance operating system: a read-only Debian root under
...
Mica OS is for teams that ship a device, not a distribution: a product integrator
