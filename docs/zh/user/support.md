...
Mica OS 是产品构建于其上的操作系统，因此支持是共担的责任：Mica OS 拥有操作系统
...
联系方式、没有公告源、也没有渠道晋级。在这些东西存在之前，**不得代表 Mica OS 向
...
1. **发布版身份**——bundle 版本、verity 根哈希，以及
   `/usr/share/mica/manifest.tsv` 中的 git 标记
