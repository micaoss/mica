...
- **SoC:** Rockchip RK3576.
- **MICA_ARCH:** `arm64`.
- **Board directory:** boards/cx3576/ (`mica-build:boards/cx3576/board.env`).

## Provenance

Input trees and their relationships:

- **Board BSP tree** (`mica-build:boards/cx3576/`): drifted derivative of
...
> status: board-dependent — evidence: `mica-build:boards/cx3576/loader/Dockerfile`
...
> status: board-dependent — evidence: `mica-build:boards/cx3576/loader/mica-file-boot.c`, `mica-build:tests/suites/lifecycle-uboot-fit/firmware-io.sh`, `mica-build:tests/suites/lifecycle-uboot-fit/signatures.sh`
...
geometry is `mica-build:boards/cx3576/board.env`. FIRMWARE covers the loader
...
- **hwinit concerns** (`BOARD_HWINIT_CONFS="otg can bt mac gadget
  ...
  per concern under
  mica-build:boards/cx3576/package/hwinit/ (`mica-build:boards/cx3576/package/hwinit/hwinit-can`), reading
...
> status: board-dependent — evidence: `mica-build:boards/cx3576/kernel/dts/rk3576-cx3576z.dts`, `docs/design/time.md`
...
> status: board-dependent — evidence: `mica-build:boards/cx3576/evidence.json`, `mica-build:tests/suites/lifecycle-uboot-fit`
