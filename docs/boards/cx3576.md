...
> status: board-dependent — evidence: `mica-boards:boards/cx3576/loader/mica-file-boot.c`, `mica-build:tests/lifecycle-uboot-fit/firmware-io.sh`, `mica-build:tests/lifecycle-uboot-fit/signatures.sh`
...
> status: board-dependent — evidence: `mica-boards:boards/cx3576/evidence.json`, `mica-build:tests/lifecycle-uboot-fit`
