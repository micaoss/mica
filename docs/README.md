...
A/B deployments managed by `mica-deploy`, and a local management API and
...
| Build and boot a device | [Quickstart](user/quickstart.md), [build guide](user/build.md), [flashing](user/flashing.md), [build design](design/build.md), [installation](user/install.md) |
