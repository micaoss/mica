...
- **status**: accepted (user, 2026-09-15); implemented since `mica-boards` `0f8e313` (the first per-board releases `<board>/20260915-0824`); the first under `docs/decisions/2026-09-15-package-versions.md` were `<board>/20260915-1128` at `ebf93f7`; current releases `<board>/20260915-1926` at `12564a3`; specified in `docs/design/release-lock.md` 1.0 and section 4; the board list format is `mica-boards`' own (`mica-boards` `ce44907`, `docs/boards/contract.md` section 3)
